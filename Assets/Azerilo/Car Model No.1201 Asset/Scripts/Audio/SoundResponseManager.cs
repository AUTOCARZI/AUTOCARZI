...
public class SoundResponseManager
{
    ...
    public void RegisterProfile(SoundResponseProfile profile)
    {
        ...
        Debug.Log($"[SoundResponseManager] Registered profile: {profile.soundType} with color: {profile.ledColor}");
    }
    ...
    {
        var profile = GetProfile(soundType);
        return profile?.ledColor ?? Color.white;
    }
    ...
    public void UpdateSoundTypeColor(SoundType soundType, Color color)
    {
        var profile = GetProfile(soundType);
        if (profile != null)
        {
            profile.ledColor = color;
            Debug.Log($"[SoundResponseManager] Updated {soundType} LED color to: {color}");
        }
    }
    ...
    public void PrintProfileInfo(SoundType soundType)
    {
        ...
        Debug.Log($"  - LED Color: {profile.ledColor}");
